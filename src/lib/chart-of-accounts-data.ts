type Account = { code: string; name: string; type: string; parentCode: string | null; level: number; isPayable: boolean; balanceType?: 'Debit' | 'Credit' | null; statement?: 'Balance Sheet' | 'Income Statement' | null; };
