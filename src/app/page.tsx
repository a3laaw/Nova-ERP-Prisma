...
import { Loader2, LogIn, LogOut, Users, Building2, DollarSign, Briefcase, CalendarDays, FileText, Settings as SettingsIcon, HardHat, ShoppingCart, BarChart3, CreditCard, UserCircle, Calculator } from 'lucide-react'
import { formatCurrency } from '@/lib/utils'

const KWD = (n: number) => formatCurrency(n)

interface NavItem { id: string; labelAr: string; icon: any; color: string }
...
export default function Home() {
  ...
  return <Dashboard activeModule={activeModule} setActiveModule={setActiveModule} session={session} />
}

function Dashboard({ activeModule, setActiveModule, session }: any) {
        ...
        {activeModule === 'dashboard' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <KpiCard icon={DollarSign} label="إجمالي الإيرادات" value={KWD(kpis.totalRevenue)} color="bg-emerald-50 text-emerald-600" />
